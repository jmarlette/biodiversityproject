...
Bryce_Observed_Weeks = fmprogram_smpsize / obs_by_park.iloc[0,1]
print("""In order to detect reductions of foot and mouth disease at Bryce National Park, 
scientists would need to observe sheep for {} weeks.""".format(Bryce_Observed_Weeks))


# In[85]:


Yellowstone_Observed_Weeks = fmprogram_smpsize / obs_by_park.iloc[2,1]
print("""In order to detect reductions of foot and mouth disease at Yellowstone National Park, 
scientists would need to observe sheep for {} weeks.""".format(Yellowstone_Observed_Weeks))
